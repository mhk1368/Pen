...
public class TeacherTransaction extends JFrame{
	
	private static final long serialVersionUID = 1L;
	public static boolean isOpen = false;
	public static TeacherTransaction self;
	...
	public TeacherTransaction(){
		...
		JLabel title = new JLabel("دریافتهای نقدی اساتید");
		...
		model = new DefaultTableModel(new String [] {"کد پرداخت", "نام استاد", "کد استاد", "مبلغ", "صندوق", "تاریخ", "شرح"}, 0)
		{
			private static final long serialVersionUID = 1L;
		...
		create.addActionListener(new OpenFrame(NewTeacherTrans.class));
	...
	private void renderData()
	{
		...
		Vector<Object> data = info.teacherTransactions(sdate, edate);
		model.setRowCount(0);
		int sum = 0;
		for(Object row : data){
