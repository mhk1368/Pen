...
public class EmployeeFinance extends JPanel{
	...
	public EmployeeFinance(int id){
		...
		JLabel title = new JLabel(" دریافتهای نقدی کارمند");
	...
	private void renderData()
	{
		...
		Vector<Object> receipts = info.employeeReceipts(empid, sdate, edate);
		model.setRowCount(0);
	...
	private void saveData()
	{
		try {
			...
			if(info.saveEmployeeReceipt(empid, val, cashid, dateString, desc.getText())){
				PenDiags.showMsg(PenDiags.SUCCESS);
